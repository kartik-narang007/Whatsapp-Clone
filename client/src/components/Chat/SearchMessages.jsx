...
function SearchMessages() {
  ...
  return (
    <div className="border-conversation-border border-left w-full bg-conversation-panel-background flex flex-col z-10 max-h-screen">
        ...
        <div className="flex justify-center h-full flex-col">
          ...
          <div className="flex flex-col w-full h-full">
            {searchedMessages.map((message) => (
              <div
                className="flex cursor-pointer flex-col justify-center hover:bg-background-defaul-hover w-full px-5 border-bottom-[
                0.1px] border-secondary py-5"
              >
